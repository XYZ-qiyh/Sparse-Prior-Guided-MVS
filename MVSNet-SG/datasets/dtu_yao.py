...
if __name__ == "__main__":
    ...
    dataset = MVSDataset("/mnt/B/qiyh/mvsnet/training_data/dtu_training/", '../lists/dtu/train.txt', 'train',
                         3, 192)
    item = dataset[50]

    #dataset = MVSDataset("/mnt/B/qiyh/mvsnet/training_data/dtu_training/", '../lists/dtu/val.txt', 'val', 3,
    #                     128)
    #item = dataset[50]

    # dataset = MVSDataset("/mnt/B/qiyh/mvsnet/training_data/dtu_training/", '../lists/dtu/test.txt', 'test', 5,
    #                     128)
    # item = dataset[50]
    ...
    print("proj_matrices", item["proj_matrices"].shape)
