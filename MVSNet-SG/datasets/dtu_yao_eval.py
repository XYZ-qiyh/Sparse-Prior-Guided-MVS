    ...
    def __getitem__(self, idx):
        ...
        for i, vid in enumerate(view_ids):
            ...
            if i == 0:  # reference view
                ...
                # read sparse depthmap for reference view
                ...
                assert sparse_depth.shape[:2] == (300, 400)
                sparse_depth = sparse_depth[:-4, :]
...
if __name__ == "__main__":
    ...
    dataset = MVSDataset("/mnt/B/MVS_GT/dtu/", '../lists/dtu/test.txt', 'test', 5,
                         128)
    item = dataset[50]
